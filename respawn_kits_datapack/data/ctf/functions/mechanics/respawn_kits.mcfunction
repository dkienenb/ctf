...
execute as @a[scores={health=1..},tag=dead] run tellraw @s {"translate":"acs.respawnkit.4","clickEvent":{"action":"run_command","value":"/trigger respawnKit set 4"}}
execute as @a[scores={health=1..},tag=dead] run tellraw @s {"translate":"acs.respawnkit.5","clickEvent":{"action":"run_command","value":"/trigger respawnKit set 5"}}
execute as @a[scores={health=1..},tag=dead] run tellraw @s {"translate":"acs.respawnkit.6","clickEvent":{"action":"run_command","value":"/trigger respawnKit set 6"}}

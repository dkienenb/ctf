...
# spots before spread
execute if score arm1 tmp matches 1 run tp @e[limit=1,type=minecraft:pig,tag=team1base] 0 63 6
execute if score arm1 tmp matches 1 run tp @e[limit=1,type=minecraft:pig,tag=team2base] 0 63 6
# 160 is spread distance
execute if score arm1 tmp matches 1 run execute as @e[limit=1,type=minecraft:pig,tag=team1base] run execute at @s run spreadplayers ~ ~ 60 60 true @s
execute if score arm1 tmp matches 1 run execute as @e[limit=1,type=minecraft:pig,tag=team2base] run execute at @s run spreadplayers ~ ~ 60 60 true @s

tellraw @s {"translate":"chat.type.text","with":[{"translate":"acs.name"},{"translate":"acs.newplayer"}]}
...
execute unless score gameState global matches 1.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"acs.name"},{"translate":"acs.clickme"}],"clickEvent":{"action":"run_command","value":"/trigger confirmed set 1"}}
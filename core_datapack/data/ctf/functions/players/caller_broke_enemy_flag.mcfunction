execute if entity @s[team=team1] run tellraw @a {"translate":"chat.type.text","with:[{"translate":"acs.name"},{"translate":"acs.flagbroken","with":[{"translate":"team.team2"},{"selector":"@s"}]}]}
...
title @a subtitle {"title":"acs.title.flagbroken","with":[{"selector":"@s"}]}

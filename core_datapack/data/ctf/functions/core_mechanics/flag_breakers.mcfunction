scoreboard objectives add blueFlagsBroken minecraft.mined:minecraft.blue_banner
scoreboard objectives add redFlagsBroken minecraft.mined:minecraft.red_banner
